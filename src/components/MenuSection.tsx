...
const menu: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Mule (Moscow / Jamaican / London)", price: "15.–" },
      { name: "Marry Love Bloody", price: "13.–" },
      { name: "Vodka / Gin", price: "13.–" },
      { name: "Rhum / Whisky + Soft", price: "13.–" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Spritz Aperol", price: "12.–" },
      { name: "Spritz Campari", price: "13.–" },
      { name: "Hugo", price: "13.–" },
    ],
  },
  {
    ...
    items: [
      { name: "Violette Cosmic", price: "14.–" },
      { name: "Space Alien", price: "16.–" },
      { name: "Mary Love Bloody", price: "14.–" },
      { name: "Rose Cosmic", price: "14.–" },
      { name: "Sex And The Galaxy", price: "16.–" },
      { name: "Not Eggs Sour", price: "14.–" },
    ],
  },
];
