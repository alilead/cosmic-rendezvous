...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="relative py-24 md:py-32 cosmic-gradient noise-bg">
      <div className="container mx-auto px-4 relative z-10">
        <div ref={ref} className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          >
            <h2 className="font-display text-3xl md:text-4xl tracking-[0.1em] mb-8 neon-glow-cyan">
